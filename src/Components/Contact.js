      ...
      <div className='max-w-[1100px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
        ...
        <div className="mt-10 flex flex-col mx-auto items-center justify-center   md:flex-row justify-around ">
            ...
            <div className="container flex flex-col  mx-auto group justify-center items-center  w-[185px] h-[90px] my-2 ">
              ...
              <span className='mt-2 lg:opacity-0 group-hover:opacity-100 transition ease-in duration-200 text-xs '>+91 9585145611</span>
            </div>


            <div className="container flex flex-col mx-auto group justify-center items-center  w-[185px] h-[90px] my-2">
              <MdEmail color="rgb(30 58 138)" size={35} />
              <span className='mt-2 lg:opacity-0 group-hover:opacity-100 transition ease-in duration-200 text-xs'>hariharamuthu1308@gmail.com</span>
            </div>


            <a className='mx-auto' href="https://www.linkedin.com/in/hariharan-m-0b7278236/" target="_blank">
              <div className="container flex flex-col mx-auto group justify-center items-center  w-[185px] h-[90px] my-2">
            ...
            <a className='mx-auto' href="https://github.com/HARIHARAN-M-044" target="_blank">
              <div className="container flex flex-col mx-auto group justify-center items-center  w-[185px] h-[90px] my-2">
