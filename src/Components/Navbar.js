      ...
      <div className='fixed flex flex-col top-[35%] left-0'>
        <ul>
          <li className=' w-[130px] h-[40px] flex justify-between items-center hover:border hover:border-black ml-[-85px] hover:ml-[-10px] duration-300'>
            <a className='flex justify-between items-center w-full' href="https://www.linkedin.com/in/hariharan-m-0b7278236/"> Linked In <FaLinkedin size={25}/> </a>
          </li>

          <li className=' w-[130px] h-[40px] flex justify-between items-center hover:border hover:border-black ml-[-85px] hover:ml-[-10px] duration-300'>
            <a className='flex justify-between items-center w-full' href="https://github.com/HARIHARAN-M-044"> Github <FaGitAlt size={25}/> </a>
          </li>
          
          <li className=' w-[130px] h-[40px] flex justify-between items-center hover:border hover:border-black ml-[-85px] hover:ml-[-10px] duration-300'>
            <a className='flex justify-between items-center w-full' href="https://drive.google.com/drive/folders/1njUw-R2O4M3QKgC9fVuCrmecwt4qxgzN"> Resume <FaClipboardList size={25}/> </a>
          </li>
        </ul>
